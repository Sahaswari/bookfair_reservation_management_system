package com.bookfair.genre_service.config;
...
import com.bookfair.genre_service.messaging.UserLifecycleEvent;
...
public class KafkaConsumerConfig {
    ...
    public KafkaConsumerConfig(UserSyncKafkaProperties userSyncKafkaProperties) {
    ...
    public ConsumerFactory<String, UserLifecycleEvent> userEventConsumerFactory(KafkaProperties kafkaProperties) {
        ...
        JsonDeserializer<UserLifecycleEvent> deserializer = new JsonDeserializer<>(UserLifecycleEvent.class);
