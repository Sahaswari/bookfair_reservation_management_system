...
import com.bookfair.genre_service.service.UserSnapshotSyncService;
...
public class UserEventListener {
    ...
    @KafkaListener(
        ...
        groupId = "${app.kafka.consumer-group-id:genre-service-user-sync}",
    ...
    public void handleUserLifecycleEvent(UserLifecycleEvent event,
        ...
        log.info("Genre service consumed user event {} from {}[{}:{}]",
    ...
    public void handleDeadLetter(UserLifecycleEvent event,
                                 @Header(KafkaHeaders.RECEIVED_TOPIC) String topic,
                                 @Header(KafkaHeaders.OFFSET) long offset) {
        log.error("User lifecycle event for user {} routed to genre-service DLT topic {} at offset {}",
